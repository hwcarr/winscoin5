...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " winstarrxcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  winstarrxcoin-tx [options] <hex-tx> [commands]  Update hex-encoded winstarrxcoin transaction\n" +
            "or:     winstarrxcoin-tx [options] -create [commands]   Create hex-encoded winstarrxcoin transaction\n" +
            "\n";
