...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.winstarrxcoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.winstarrxcointools.com");
        vSeeds.emplace_back("dnsseed.winstarrxcoinpool.org");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.winstarrxcointools.com");
        vSeeds.emplace_back("seed-b.winstarrxcoin.loshan.co.uk");
