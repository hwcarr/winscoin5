...
"""Verify that starting winstarrxcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start winstarrxcoin with -h for help text")
        ...
        self.log.info("Start winstarrxcoin with -version for version information")
        ...
        self.log.info("Start winstarrxcoind with -fakearg to make sure it does not start")
